        ...
        <div class="p-6">
            <div class="grid grid-cols-2 gap-4 text-sm">
                ...
                <div class="col-span-2">
                    ...
                    <span class="text-gray-300 text-xs">{{ $service->last_synced_at->format('Y/m/d H:i') }} ({{ $service->last_synced_at->diffForHumans() }})</span>
                </div>
                @endif
            </div>
            ...
            <div class="mt-5 pt-4 border-t border-gray-800">
                <form method="POST" action="{{ route('dashboard.services.refresh', $service) }}">
                    @csrf
                    <button type="submit"
                            class="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white text-sm px-4 py-2.5 rounded-lg transition">
