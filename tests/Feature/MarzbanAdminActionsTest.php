...
class MarzbanAdminActionsTest extends TestCase
{
    ...
    public function test_reset_traffic_calls_reset_endpoint(): void
    {
        ...
        Http::assertSent(fn ($req) => str_contains($req->url(), '/api/user/zpx_reset_test/reset') &&
            $req->method() === 'POST'
        );
    }
    ...
    public function test_revoke_subscription_calls_revoke_sub_endpoint(): void
    {
        ...
        Http::assertSent(fn ($req) => str_contains($req->url(), '/api/user/zpx_revoke_test/revoke_sub') &&
            $req->method() === 'POST'
        );
    }
    ...
    public function test_disable_calls_put_with_status_disabled(): void
    {
        ...
        Http::assertSent(fn ($req) => str_contains($req->url(), '/api/user/zpx_disable_test') &&
            $req->method() === 'PUT' &&
    ...
    public function test_enable_calls_put_with_status_active(): void
    {
        ...
        Http::assertSent(fn ($req) => str_contains($req->url(), '/api/user/zpx_enable_test') &&
            $req->method() === 'PUT' &&
    ...
    public function test_delete_remote_calls_delete_endpoint_and_keeps_local_service(): void
    {
        ...
        Http::assertSent(fn ($req) => str_contains($req->url(), '/api/user/zpx_delete_test') &&
            $req->method() === 'DELETE'
        );
