...
class ThemeTest extends TestCase
{
    ...
    // ── Appearance settings page (تنظیمات ظاهر) ─────────────────────────────
    ...
    public function test_old_theme_studio_url_redirects_to_appearance(): void
    {
        $this->actingAs($this->admin())
    ...
    /** Saving writes the right keys and never wipes unrelated keys. */
    public function test_appearance_settings_persist_and_preserve_keys(): void
    {
        // Keys NOT exposed by this page must survive a save untouched.
        SiteSetting::set('card_radius', '16px');
        SiteSetting::set('default_theme_public', 'zed-aurora');
        ...
        // Both appearance keys stay in sync (new + legacy resolvers agree).
