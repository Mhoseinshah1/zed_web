        ...
        return $form->schema([
            Forms\Components\Section::make()->schema([
                Forms\Components\TextInput::make('question')
                    ->label('سوال')->required()->maxLength(255)->columnSpanFull(),
                Forms\Components\Textarea::make('answer')
                    ->label('پاسخ')->required()->rows(4)->columnSpanFull(),
                Forms\Components\TextInput::make('category')
                    ->label('دسته‌بندی')->maxLength(100)->placeholder('اختیاری'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('question')->label('سوال')->searchable()->limit(60)->wrap(),
